...
const char tn_usage08[]  = "   config; telnet; rf24; sql; sensor; node; order; orderext; obuffer; obufferext; other; pointer";
...
const char tn_usage24[]  = "show node";
const char tn_usage25[]  = "   lists the nodes in system";
const char tn_usage26[]  = "show sensor";
const char tn_usage27[]  = "   lists the sensors in system";
const char tn_usage28[]  = "show gateway";
const char tn_usage29[]  = "   lists the gateways in system";
const char tn_usage30[]  = "show verbose";
const char tn_usage31[]  = "   list the current verbose level(s)";
const char tn_usage32[]  = "truncate logfile";
const char tn_usage33[]  = "   truncates the logfile";

const char *tn_usage_txt[] = {  tn_usage01, tn_usage02, tn_usage03, tn_usage04, tn_usage05, 
                                tn_usage06, tn_usage07, tn_usage08, tn_usage09, tn_usage10,
                                tn_usage11, tn_usage12, tn_usage13, tn_usage14, tn_usage15,
                                tn_usage16, tn_usage17, tn_usage18, tn_usage19, tn_usage20,
                                tn_usage21, tn_usage22, tn_usage23, tn_usage24, tn_usage25,
                                tn_usage26, tn_usage27, tn_usage28, tn_usage29, tn_usage30,
                                tn_usage31, tn_usage32, tn_usage33 };
                               
unsigned int tn_usage_size = 33;
