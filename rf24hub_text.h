...
const char tn_usage10[]  = "set gateway <gateway_no> <on/off>";
const char tn_usage11[]  = "   sets a gateway active (on) or inactive (off)";
const char tn_usage12[]  = "add gateway <gatewayname> <gateway_no>";
const char tn_usage13[]  = "   adds a active gateway to the system";
const char tn_usage14[]  = "delete gateway <gateway_no>";
const char tn_usage15[]  = "   deletes a gateway from the system";
const char tn_usage16[]  = "init";
const char tn_usage17[]  = "   Reinitialisation of rf24hub";
const char tn_usage18[]  = "sync";
const char tn_usage19[]  = "   Syncs all in Memory tables to the persistent tables";
const char tn_usage20[]  = "show order";
const char tn_usage21[]  = "   lists the content of the order queue";
const char tn_usage22[]  = "show sensor";
const char tn_usage23[]  = "   lists the nodes and sensors in system";
const char tn_usage24[]  = "show gateway";
const char tn_usage25[]  = "   lists the gateways in system";
const char tn_usage26[]  = "show verbose";
const char tn_usage27[]  = "   list the current verbose level(s)";
const char tn_usage28[]  = "truncate logfile";
const char tn_usage29[]  = "   truncates the logfile";
